...
<?php $script=""; ?>
    ...
    <?php ob_start(); ?>
		...
		<h4 class="phraseRetourAdmin">Vous allez modifier la categorie : <em><?= htmlspecialchars($categorie['titre_categorie']); ?></em></h4>		
	    
	    <div class="container-fluid" id="ajoutChapitre">
	    	<form action="index.php?action=categorieModif&amp;id=<?= htmlspecialchars($categorie['id']); ?>" method="post"><br>
		        <div class="container  col-md-9">
		            <div class="md-form mb-3">
		                <label id="titreArticle">Titre de la categorie : </label>
		                <input type="text" name="titre_categorie" placeholder="Titre de l'article" value="<?= htmlspecialchars($categorie['titre_categorie']); ?>" class="form-control">		                            
		            </div>
